...
public class PodcastFolderUtils {
     ...
     * @return string
     */
    public static String getPodcastPostsFolder (String podcastFolderPath) {
     ...
     * @param podcastFolderPath Podcast folder path provided by user of the API
     */
    public static boolean checkPodcastFolder (String podcastFolderPath) {
     ...
     * false.
     */
    public static boolean checkPodcastPostsFolder (String folderPath) {
     ...
     */
    public static List<File> collectPostsFolderPath (String podcastFolderPath) {
        if(checkPodcastFolder(podcastFolderPath)) {
            ...
            if(Objects.nonNull(postsFiles))
                return Arrays.asList(postsFiles).stream()
